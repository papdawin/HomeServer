...
[ -n "$radarr_api_key" ] || { log "Radarr API key missing; set PROWLARR_RADARR_API_KEY"; exit 1; }
[ -n "$sonarr_api_key" ] || { log "Sonarr API key missing; set PROWLARR_SONARR_API_KEY"; exit 1; }
